...
public class MainMapa {
	...
	public static void main(String[] args) {
		...
		Map <Integer,Movil> mapa = new HashMap<Integer,Movil>();//lo ordena sin orden
		...
		//mapa.clear();
		Map<Integer,Movil>treemap=new TreeMap<Integer,Movil>();//los ordena de menor a mayor
		...
		System.out.println(treemap.containsKey(2));//devuelve true si el mapa contiene esa clave
		...
		//treemap.clear();
		Map<Integer,Movil>linkedhashmap=new LinkedHashMap<Integer,Movil>();//los ordena por orden de introducción
		linkedhashmap.put(4, movil3);
		linkedhashmap.put(3, movil1);
		linkedhashmap.put(2, movil2);
		linkedhashmap.put(1, movil4);

		System.out.println(linkedhashmap.remove(3));//borra el movil con esa clave
		System.out.println(linkedhashmap.get(4));//devuelve el movil con esa clave
		System.out.println(linkedhashmap.containsKey(2));//devuelve true si el mapa contiene esa clave
		System.out.println(linkedhashmap.values());//devuelve el mapa como una lista
		System.out.println(linkedhashmap.size());//devuelve el tamao del mapa
		//treemap.clear();
		
		Map<Integer,Movil>Weakhashmap=new WeakHashMap<Integer,Movil>();//al paso de un tiempo se borran
